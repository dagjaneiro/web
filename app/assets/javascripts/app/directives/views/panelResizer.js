export class PanelResizer {
  ...
  controller(
    ...
    const resizerColumn = $element[0];
    const resizerWidth = resizerColumn.offsetWidth;
    ...
    $scope.setWidth = function(width, finish) {
      ...
      const maxWidth = appFrame.width - panel.getBoundingClientRect().x;
      if (width > maxWidth) {
        width = maxWidth;
      }
    ...
    document.addEventListener('mouseup', event => {
      ...
      if (pressed) {
        ...
        const isMaxWidth = $scope.isAtMaxWidth();
