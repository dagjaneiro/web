...
export function tagsCtrl(
  ...
  this.loadPreferences = function() {
    const width = authManager.getUserPrefValue('tagsPanelWidth');
    if (width) {
  ...
  componentManager.registerHandler({
    identifier: 'tags',
    areas: ['tags-list'],
    activationHandler: function(component) {
      this.component = component;
    }.bind(this),
    contextRequestHandler: function(component) {
      return null;
    },
